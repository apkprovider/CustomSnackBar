...
public class CustomSnackBar {
    ...
    //Change duration whether CustomSnackBar should be shown for short, long or Indefinite
    ...
    public CustomSnackBar customTitleFont(Typeface tf){
        this.mTfTitle = tf;
        return this;
    }

    //Change font for title
    public CustomSnackBar customActionFont(Typeface tf){
        this.mTfAction = tf;
        return this;
    }


    public CustomSnackBar setIconForTitle(Drawable titleDrawable, IconPosition iconPostion, int drawablePadding){
    ...
    public CustomSnackBar setIconForAction(Drawable actionDrawable, IconPosition iconPostion,int drawablePadding){
    ...
    //Listeners to handle CustomSnackBar Action click
